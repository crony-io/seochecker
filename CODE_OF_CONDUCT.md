...
1. Create a GitHub issue in this repository describing what happened (include links/screenshots when possible).
2. If the report contains sensitive information, do not post it publicly. Instead, contact the repository owners/maintainers directly via their GitHub profiles.

Project maintainers will review reports in a timely manner, investigate in good faith, and take appropriate action while prioritizing safety and confidentiality.

## Addressing and Repairing Harm

If project maintainers determine that this Code of Conduct has been violated, the enforcement ladder below may be used to decide how to address the situation, based on severity and impact. Depending on the severity of a violation, lower steps may be skipped.
...
- Temporary Suspension
  ...
  - Event: A pattern of repeated violation which project maintainers have tried to address with warnings, or a single serious violation.
...
- Permanent Ban
  ...
  - Event: A pattern of repeated code of conduct violations that other steps on the ladder have failed to resolve, or a violation so serious that project maintainers determine there is no way to keep the community safe with this person as a member.
...
This enforcement ladder is intended as a guideline. Project maintainers may use their discretion and judgment in the best interests of the community.
